...
docker buildx build \
  ...
  --tag ghcr.io/yourusername/delerium-paste-mono-server:latest \
  --push \
  .
```
...
docker pull ghcr.io/yourusername/delerium-paste-mono-server:latest
...
docker run --platform linux/arm64 ghcr.io/yourusername/delerium-paste-mono-server:latest

# Run on AMD64 explicitly
docker run --platform linux/amd64 ghcr.io/yourusername/delerium-paste-mono-server:latest
```
...
docker buildx imagetools inspect ghcr.io/yourusername/delerium-paste-mono-server:latest

# Output shows available platforms:
# Name:      ghcr.io/yourusername/delerium-paste-mono-server:latest
# MediaType: application/vnd.docker.distribution.manifest.list.v2+json
# Digest:    sha256:...
#
# Manifests:
#   Name:      ghcr.io/yourusername/delerium-paste-mono-server:latest@sha256:...
...
docker pull --platform linux/amd64 delerium-paste-mono-server:latest
```
...
git clone https://github.com/yourusername/delerium-paste-mono.git
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: server
        image: ghcr.io/yourusername/delerium-paste-mono-server:latest

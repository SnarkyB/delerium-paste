...
# Use the unified CLI instead: ./delerium security check

echo "⚠️  WARNING: This script is deprecated!"
echo ""
echo "   Old command: ./scripts/security-check.sh"
echo "   New command: ./delerium security check"
echo ""
...
cd "$(dirname "$0")/.." && ./delerium security check "$@"

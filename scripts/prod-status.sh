...
# Use the unified CLI instead: ./delerium status

echo "⚠️  WARNING: This script is deprecated!"
echo ""
echo "   Old command: ./scripts/prod-status.sh"
echo "   New command: ./delerium status"
echo ""
...
cd "$(dirname "$0")/.." && ./delerium status --detailed "$@"

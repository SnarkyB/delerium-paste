...
describe('DOM Interaction Functions', () => {
  ...
  describe('Loading States', () => {
    beforeEach(() => {
      // Setup setButtonLoading function
    ...
    it('should restore button from loading state', () => {
      ...
      expect(btnText.innerHTML).toContain('Upload');
    ...
    it('should handle multiple loading state changes', () => {
      ...
      // Test sequence of loading states
      (window as any).setButtonLoading(true, 'Preparing...');
      expect(btnText.innerHTML).toContain('Preparing...');

      (window as any).setButtonLoading(true, 'Encrypting...');
      expect(btnText.innerHTML).toContain('Encrypting...');

      (window as any).setButtonLoading(true, 'Uploading...');
      expect(btnText.innerHTML).toContain('Uploading...');
    ...
    it('should handle delete button loading state', () => {
